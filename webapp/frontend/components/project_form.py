...
def form_project() -> rx.Component:
        ...
        return rx.dialog.content(
            ...
            rx.form(
                ...
                rx.input(placeholder="Enter your project name",
                            name="name",
                            required=True),
                rx.heading("Type of device *",size="3"),
                rx.select(device_class, 
                        placeholder="Select Device Class",
                        name="class",
                        required=True),
                rx.heading("Project Description",size="3"),
                rx.text_area(
                ...
                rx.hstack(
                        ...
                        upload_image_project(title="Image",my_image=rx.get_upload_url(ProjectState.image)),
                        ),
